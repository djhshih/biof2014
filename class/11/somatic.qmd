...
define because it now depends on the joint genotype of the tumour
sample as its matched normal sample. Rather than defining $\mu_g$ directly,
...
and to incorporate uncertainty or variability in $\mu_g$.
...
formally define $G$ as the joint genotype of tumour-normal pair (Table 1).
