...
Finally,
$$
p\left( \theta \mid x \right) = 2 \, \theta^x (1- \theta)^{1 - x} .
$$
...
```{r, fig.width=3, fig.height=3, out.width="25%"}
plot_dbeta(1, 1)
```
$$
\text{Beta}\left(x \mid 1, 1\right)
 = B(\alpha, \beta)^{-1} x^{\alpha - 1} (1 - x)^{\beta - 1}
 = 1
$$
...
Casella & Berger 2002, section 1.3 (pages 20--24)  
Exercises (page 41) 1.33, 1.34, 1.36, 1.37, 1.41
