...
"The probability that the random variable $X$ equals a value $x_i$ is given 
under the induced probability function $P_X$ by the probability of the event 
$\mathcal{E}_i$, which is the set of all outcomes $s_j$ in the sample space 
