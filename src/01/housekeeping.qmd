...
| Code novelty\*                            |  20%   |
| Commit pattern                            |  20%   |
| Model performance, development            |  20%   |
| Model performance, production             |  40%   |

\* >90\% similarity with another submission from any time 
results in a grade of zero for the entire project.
